...
const TermsOfUsePage: NextPageWithLayout = () => (
  <div className={`my-5 container text-white ${styles.documentRoot}`}>
    <div>
      ...
      <p>
        We are Angel Bridge (&quot;<strong>we</strong>,&quot; &quot;<strong>us</strong>
        ,&quot; &quot;<strong>our</strong>&quot;).
      </p>
      <p>
        We operate the website{' '}
        <Link className="link" href="https://angel-bridge.jerrycool123.com/">
          https://angel-bridge.jerrycool123.com
        </Link>{' '}
        (the &quot;<strong>Site</strong>&quot;), as well as any other related products and services
        that refer or link to these legal terms (the &quot;<strong>Legal Terms</strong>&quot;)
        (collectively, the &quot;
        <strong>Services</strong>&quot;).
      </p>
      <p>
        Angel Bridge is a Discord bot verifying YouTube channel memberships &amp; linking them with
        Discord server roles.
      </p>
      <p>You can contact us by email at jerrycool71534@gmail.com.</p>
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether
        personally or on behalf of an entity (&quot;<strong>you</strong>&quot;), and Angel Bridge,
      ...
      <p>
        ...
        idea, feedback, or other information about the Services (&quot;Submissions&quot;), you agree
        to assign to us all intellectual property rights in such Submission. You agree that we shall
      ...
      <p>
        ...
        under the age of 13; (5) you are not a minor in the jurisdiction in which you reside, or if
        a minor, you have received parental permission to use the Services; (6) you will not access
      ...
      <p>Angel Bridge is free to use.</p>
      <h2>6. CANCELLATION</h2>
      <p>You can revoke your authorization on Angel Bridge&apos;s dashboard at any time.</p>
      <p>If you are unsatisfied with our Services, please email us at jerrycool71534@gmail.com.</p>
      ...
      <p>
        ...
        information to us and/or grant us access to your Third-Party Account, without breach by you
        of any of the terms and conditions that govern your use of the applicable Third-Party
        ...
        your Third-Party Account (the &quot;Social Network Content&quot;) so that it is available on
        ...
        extent you are notified when you link your account with the Third-Party Account. Depending
        on the Third-Party Accounts you choose and subject to the privacy settings that you have set
        in such Third-Party Accounts, personally identifiable information that you post to your
        ...
        ability to disable the connection between your account on the Services and your Third-Party
        ...
        and your contacts list stored on your mobile device or tablet computer solely for purposes
        of identifying and informing you of those contacts who have also registered to use the
      ...
      <p>
        ...
        <Link className="link" href="https://angel-bridge.jerrycool123.com/privacy">
          https://angel-bridge.jerrycool123.com/privacy
        </Link>
        . By using the Services, you agree to be bound by our Privacy Policy, which is incorporated
        into these Legal Terms. Please be advised the Services are hosted in Taiwan. If you access
        the Services from any other region of the world with laws or other requirements governing
        personal data collection, use, or disclosure that differ from applicable laws in Taiwan,
        then through your continued use of the Services, you are transferring your data to Taiwan,
        and you expressly consent to have your data transferred to and processed in Taiwan. Further,
      ...
      <p>
        These Legal Terms shall be governed by and defined following the laws of Taiwan. Angel
      ...
      <p>
        ...
        Angel Bridge shall also maintain the right to bring proceedings as to the substance of the
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            <Link className="link" href="https://angel-bridge.jerrycool123.com" target="_blank">
              https://angel-bridge.jerrycool123.com
            </Link>
          </p>
        </li>
