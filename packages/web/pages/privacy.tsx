    ...
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Angel Bridge.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Angel Bridge, accessible from{' '}
      ...
      <ul>
        ...
        <li>
          ...
          and single-pixel gifs) that permit Us, for example, to count users who have visited those
      ...
      <ul>
        <li>
          <p>
            <strong>Access and Use</strong>: We will only access and use your Google user data when
            you opt in to use our functionalities. We DO NOT actively collect these data for any
            other purpose.
          </p>
        </li>
        <li>
          <p>
            ...
            after you authorized Us for specific permissions in the Google OAuth Consent Screen. The
        ...
        <li>
          <p>
            <strong>Share</strong>: We DO NOT share your refresh tokens or sensitive user data under
            any case.
          </p>
        </li>
      </ul>
      ...
      <ul>
        <li>
          <p>
            ...
            verify your YouTube channel membership on Angel Bridge. We will only use this scope to
            try to read comments from members-only videos on your behalf, in order to verify whether
            you are a member of that channel. WE DO NOT EDIT OR DELETE YOUR VIDEOS, RATINGS,
            COMMENTS AND CAPTIONS UNDER ANY CIRCUMSTANCES. BESIDES, WE DO NOT ACCESS YOUR OTHER
            ACCESSIBLE DATA IN YOUR YOUTUBE ACCOUNT WHICH IS NOT RELATED TO THE PURPOSE STATED
            ABOVE.
          </p>
        </li>
      </ul>
      ...
      <p>
        Your information, including Personal Data, is processed at our&apos;s operating offices and
