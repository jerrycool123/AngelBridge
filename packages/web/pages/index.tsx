      ...
      <section className={styles.featuresSection}>
        <div className="container">
          <div className="row mb-3">
            <div>
              <h2 className="text-center poppins">What is Angel Bridge</h2>
            </div>
          </div>
          <div className="row d-flex justify-content-center mb-5">
            <div className={`col-lg-8 ${styles.introduction}`}>
              ...
              <p className="fs-5">
                Angel Bridge provides two methods to verify your membership:{' '}
          ...
          <div className="row mb-5 d-flex justify-content-center">
            <div className="col-lg-5 d-flex flex-column align-items-center">
              ...
              <div className={styles.modeIntro}>
                <p className={`mb-2 ${styles.introduction}`}>
                  Angel Bridge will automatically check your membership periodically.
                </p>
            ...
            <div className="col-lg-5 d-flex flex-column align-items-center">
              ...
              <div className={styles.modeIntro}>
                ...
                <p className={styles.introduction}>
                  Provide a screenshot of your purchases page on YouTube. Angel Bridge use
          ...
          <div className="row mb-3">
            <div>
              <h2 className="text-center poppins">Why Angel Bridge</h2>
            </div>
          </div>
          <div className="row d-flex justify-content-center">
            <div className={`col-lg-8 ${styles.introduction}`}>
              ...
              <p>
                Considering the problems above, Angel Bridge implements both methods. You can choose
                the one you prefer. If you choose to use the OAuth method, we will store your OAuth
                credentials in our database with proper encryption, and we will never use them for
                any other purpose. You can also revoke the authorization at any time on our
              ...
              <p>
                Angel Bridge is open-sourced and has MIT License. We also host a public Discord bot{' '}
                <Link
                  className="link fw-500"
                ...
                <Link className="link fw-500" href="https://github.com/jerrycool123/AngelBridge">
